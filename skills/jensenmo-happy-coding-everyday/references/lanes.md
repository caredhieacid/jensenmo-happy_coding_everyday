...
- a formal PR, rollout, real environment, or E2E acceptance path is central to the request;
...
Never upgrade because a workflow is fashionable, because agents are available, or because the task merely sounds important.
